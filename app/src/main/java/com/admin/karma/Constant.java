...
public class Constant {
    ...
    public static String APP_URL = "https://www.facebook.com/abenezer.abebe";
    public static String DESIGNED_BY = "Designed by Abenezer Abebe";
    public static String SHARE_CONTENT = "A beautiful app designed with Material Design:\n" + APP_URL + "\n- " + DESIGNED_BY;
    public static String EMAIL = "abenezer.abeti@gmail.com";
    public static String GIT_HUB = "https://www.facebook.com/abenezer.abebe";
